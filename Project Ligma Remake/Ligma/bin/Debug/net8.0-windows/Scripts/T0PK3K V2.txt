...
pool.get("global", "gui").root.main.blabel.Text = "RC7 Edition"
...
pool.windows.open = function(w)
	...
	for i, v in pairs(pool.windows.wpool) do
        ...
        handle.Position = handle.Position + UDim2.new(-1.5, 0, 0, 0)
        handle.Visible = true
        oldc.Visible = true
        
        handle:TweenPosition(UDim2.new(0, 8, 0, 34), "In", "Quad", 0.8)
        oldc:TweenPosition(oldc.Position + UDim2.new(1.5, 0, 0, 0), "Out", "Quad", 0.8)
        wait(0.9)
        oldc.Visible = false
        oldc.Position = UDim2.new(0, 8, 0, 34)
...
function splash()
	...
	--SplashFrame:TweenSizeAndPosition(UDim2.new(0,150,0,30),UDim2.new(0.5,0,1,-25))
...
pool.get("global", "gui").Parent = player.PlayerGui
...
-- too lazy to update gui, just selfgen
